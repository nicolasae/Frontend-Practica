...
const Cancelados = () =>{
    ...
    const getDataCanceladosPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Cancelado&COD_PERIODO='+ yearSelected +'-1',
        headers: { 
    ...
    const getDataCanceladosSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Cancelado&COD_PERIODO='+ yearSelected +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataCanceladosSexoPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Cancelado&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-1',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Cancelado&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-1',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataCanceladosSexoSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Cancelado&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Cancelado&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-2',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataCanceladosEstratoPrimerSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Cancelado&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-1',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataCanceladosEstratoSegundoSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Cancelado&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-2',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataCanceladosColegio = async() =>{ 
        ...
        for (var tipo = 0;tipo<3;tipo++){
            for (var year = 2010;year <= actualYear;year++){
                var config = {
                    method: 'get',
                    url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Cancelado&TIPO_COLEGIO='+tiposColegio[tipo]+'&COD_PERIODO='+ year,
                    headers: { 
                        'Content-Type': 'application/json'
                    },
                };
    ...
    const getDataCanceladosList = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Cancelado',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataTipoInscripcion= async () => {
        ...
        for (var opcion = 0;opcion< opcionesMultiSelect.length;opcion++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count_year?VAR=Cancelado&TIPO_INSCRIPCION='+ opcionesMultiSelect[opcion],
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
