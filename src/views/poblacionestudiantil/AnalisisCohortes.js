...
import {
 ...
 const AnalisisCohorte = () =>{
    ...
    const getDataTablePregrado = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/analisiscohorte?NIVEL=Pregrado',
        headers: { 
    ...
    const getDataTablePosgrado = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/analisiscohorte?NIVEL=Posgrado',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataWidgetPregrado = async () => {
        ...
        for (const i in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedPregrado + '&NIVEL=Pregrado&ESTADO='+ estados[i] ,
            headers: { 
                'Content-Type': 'application/json'
            },
            };
            ...
            var configPrimer = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedPregrado + '-1&NIVEL=Pregrado&ESTADO='+ estados[i] ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
            ...
            var configSegundo = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedPregrado+'-2&NIVEL=Pregrado&ESTADO='+ estados[i] ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
    ...
    const getDataWidgetPosgrado = async () => {
        ...
        for (const i in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedPosgrado + '&NIVEL=Posgrado&ESTADO='+ estados[i] ,
            headers: { 
                'Content-Type': 'application/json'
            },
            };
            ...
            var configPrimer = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedPosgrado + '-1&NIVEL=Posgrado&ESTADO='+ estados[i] ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
            ...
            var configSegundo = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedPosgrado+'-2&NIVEL=Posgrado&ESTADO='+ estados[i] ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
    ...
    const getDataPieChartPregrado = async() =>{
        ...
        for (const i in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedSemestrePregrado + '&NIVEL=Pregrado&ESTADO='+ estados[i]+'&NOMBRE='+ programaSelectedPregrado ,
            headers: { 
                'Content-Type': 'application/json'
            },
            };
            ...
            var configPrimer = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedSemestrePregrado + '-1&NIVEL=Pregrado&ESTADO='+ estados[i] +'&NOMBRE='+ programaSelectedPregrado  ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
            ...
            var configSegundo = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedSemestrePregrado +'-2&NIVEL=Pregrado&ESTADO='+ estados[i] +'&NOMBRE='+ programaSelectedPregrado ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
    ...
    const getDataPieChartPosgrado = async() =>{
        ...
        for (const i in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedSemestrePosgrado + '&NIVEL=Posgrado&ESTADO='+ estados[i]+'&NOMBRE='+ programaSelectedPosgrado ,
            headers: { 
                'Content-Type': 'application/json'
            },
            };
            ...
            var configPrimer = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedSemestrePosgrado + '-1&NIVEL=Posgrado&ESTADO='+ estados[i] +'&NOMBRE='+ programaSelectedPosgrado  ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
            ...
            var configSegundo = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count?COD_PERIODO='+ yearSelectedSemestrePosgrado +'-2&NIVEL=Posgrado&ESTADO='+ estados[i] +'&NOMBRE='+ programaSelectedPosgrado ,
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
    ...
    const getDataAnualPregrado = async() =>{
        ...
        for (var estado in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count_year?NOMBRE='+programaSelectedPregrado +'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const getDataAnualPosgrado = async() =>{
        ...
        for (var estado in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/analisiscohorte_count_year?NOMBRE='+programaSelectedPosgrado +'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const handleChangeProgramaPregrado = async (event) =>  {
        ...
        await setLoadingGraficoSemestrePregrado(true)
    }
