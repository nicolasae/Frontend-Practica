...
const Matriculados = () =>{
    ...
    const getDataMatriculadosPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Matriculado&COD_PERIODO='+ yearSelected +'-1',
        headers: { 
    ...
    const getDataMatriculadosSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Matriculado&COD_PERIODO='+ yearSelected +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataMatriculadosSexoPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Matriculado&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-1',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Matriculado&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-1',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataMatriculadosSexoSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Matriculado&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Matriculado&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-2',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataMatriculadosEstratoPrimerSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Matriculado&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-1',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataMatriculadosEstratoSegundoSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Matriculado&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-2',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataMatriculadosColegio = async() =>{ 
        ...
        for (var tipo = 0;tipo<3;tipo++){
            for (var year = 2010;year <= actualYear;year++){
                var config = {
                    method: 'get',
                    url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Matriculado&TIPO_COLEGIO='+tiposColegio[tipo]+'&COD_PERIODO='+ year,
                    headers: { 
                        'Content-Type': 'application/json'
                    },
                };
    ...
    const getDataMatriculadosList = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Matriculado',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataTipoInscripcion= async () => {
        ...
        for (var opcion = 0;opcion< opcionesMultiSelect.length;opcion++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count_year?VAR=Matriculado&TIPO_INSCRIPCION='+ opcionesMultiSelect[opcion],
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
