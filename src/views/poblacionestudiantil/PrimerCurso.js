...
const PrimerCurso = () =>{
    ...
    const getDataPrimerCursoPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Primer curso&COD_PERIODO='+ yearSelected +'-1',
        headers: { 
    ...
    const getDataPrimerCursoSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Primer curso&COD_PERIODO='+ yearSelected +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataPrimerCursoSexoPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Primer curso&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-1',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Primer curso&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-1',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataPrimerCursoSexoSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Primer curso&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Primer curso&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-2',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataPrimerCursoEstratoPrimerSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Primer curso&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-1',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataPrimerCursoEstratoSegundoSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Primer curso&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-2',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };            
    ...
    const getDataPrimerCursoColegio = async() =>{ 
        ...
        for (var tipo = 0;tipo<3;tipo++){
            for (var year = 2010;year <= actualYear;year++){
                var config = {
                    method: 'get',
                    url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Primer curso&TIPO_COLEGIO='+tiposColegio[tipo]+'&COD_PERIODO='+ year,
                    headers: { 
                        'Content-Type': 'application/json'
                    },
                };
    ...
    const getDataMatriculadosList = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Primer curso',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataTipoInscripcion= async () => {
        ...
        for (var opcion = 0;opcion< opcionesMultiSelect.length;opcion++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count_year?VAR=Primer curso&TIPO_INSCRIPCION='+ opcionesMultiSelect[opcion],
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
