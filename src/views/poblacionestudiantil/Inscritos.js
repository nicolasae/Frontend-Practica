...
const Inscritos = () =>{
    ...
    const getDataInscritosPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Inscrito&COD_PERIODO='+ yearSelected +'-1',
        headers: { 
    ...
    const getDataInscritosSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Inscrito&COD_PERIODO='+ yearSelected +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataInscritosSexoPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Inscrito&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-1',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Inscrito&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-1',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataInscritosSexoSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Inscrito&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Inscrito&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-2',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataInscritosEstratoPrimerSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Inscrito&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-1',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataInscritosEstratoSegundoSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Inscrito&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-2',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataInscritosColegio = async() =>{ 
        ...
        for (var tipo = 0;tipo<3;tipo++){
            for (var year = 2010;year <= actualYear;year++){
                var config = {
                    method: 'get',
                    url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Inscrito&TIPO_COLEGIO='+tiposColegio[tipo]+'&COD_PERIODO='+ year,
                    headers: { 
                        'Content-Type': 'application/json'
                    },
                };
    ...
    const getDataInscritosList = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Inscrito',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataTipoInscripcion= async () => {       
        ...
        for (var opcion = 0;opcion< opcionesMultiSelect.length;opcion++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count_year?VAR=Inscrito&TIPO_INSCRIPCION='+ opcionesMultiSelect[opcion],
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
