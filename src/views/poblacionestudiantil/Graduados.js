...
const Graduados = () =>{
    ...
    const [loadingSexo, setLoadingSexo] = React.useState(true)
    ...
    const getDataGraduadosPrimerSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Graduado&COD_PERIODO='+ yearSelected +'-1',
        headers: { 
    ...
    const getDataGraduadosSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Graduado&COD_PERIODO='+ yearSelected +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        ...
        await setLoadingGeneral(false)
    }
    const getDataGraduadosSexoPrimerSemestre = async () => {
        var axios = require('axios');
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Graduado&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-1',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Graduado&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-1',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataGraduadosSexoSegundoSemestre = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Graduado&SEXO=Masculino&COD_PERIODO='+ yearSelectedSexo +'-2',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        var config1 = {
            method:'get',
            url:'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Graduado&SEXO=Femenino&COD_PERIODO='+ yearSelectedSexo +'-2',
            headers: { 
                'Content-Type': 'application/json'
            },
        }
    ...
    const getDataGraduadosEstratoPrimerSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Graduado&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-1',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
    ...
    const getDataGraduadosEstratoSegundoSemestre = async() =>{ 
        ...
        for (var i = 0;i<7;i++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Graduado&ESTRATO='+estratos[i]+'&COD_PERIODO='+ yearSelectedEstrato +'-2',
                headers: { 
                    'Content-Type': 'application/json'
                },
            };            
    ...
    const getDataGraduadosColegio = async() =>{ 
        ...
        for (var tipo = 0;tipo<3;tipo++){
            for (var year = 2010;year <= actualYear;year++){
                var config = {
                    method: 'get',
                    url: 'https://backend-practica.herokuapp.com/api/tendencia_count?VAR=Graduado&TIPO_COLEGIO='+tiposColegio[tipo]+'&COD_PERIODO='+ year,
                    headers: { 
                        'Content-Type': 'application/json'
                    },
                };
    ...
    const getDataMatriculadosList = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/tendencia?VAR=Graduado',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
        ...
        var aux = []
        for ( const i in graduadosquery){
            if((graduadosquery[i]['TIPO_INSCRIPCION']!== null) ){
                aux.push(graduadosquery[i]['TIPO_INSCRIPCION'])
            }
        }
    ...
    const getDataTipoInscripcion= async () => {
        ...
        var axios = require('axios');
        let aux = yearsDataSemestre;
        for (var opcion = 0;opcion< opcionesMultiSelect.length;opcion++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/tendencia_count_year?VAR=Graduado&TIPO_INSCRIPCION='+ opcionesMultiSelect[opcion],
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
