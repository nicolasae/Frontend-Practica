...
const Dashboard = () => {
  ...
  const [estadosDIA] = React.useState(['Permanece programa','Graduado','Cambio de programa','No matriculado'])
  ...
  const [estadosDIS] = React.useState(['Permanece programa','Graduado','Cambio de programa','No matriculado'])
  ...
  const getDataTotal = async () => {
    ...
    for (var i = 0; i < estados.length; i++) {
      var config = {
        method: "get",
        url:"https://backend-practica.herokuapp.com/api/tendencia_count?VAR=" + estados[i] +"&COD_PERIODO=" +yearSelected,
        headers: {
      ...
      var configPrimer = {
        method: "get",
        url:"https://backend-practica.herokuapp.com/api/tendencia_count?VAR=" + estados[i] +"&COD_PERIODO=" +yearSelected+'-1',
        headers: {
          "Content-Type": "application/json",
        },
      };
      var configSegundo = {
        method: "get",
        url:"https://backend-practica.herokuapp.com/api/tendencia_count?VAR=" + estados[i] +"&COD_PERIODO=" +yearSelected+'-2',
        headers: {
          "Content-Type": "application/json",
        },
      };
  ...
  const getDataYearsGeneral = async () => {
    ...
    for (var estado = 0;estado<5;estado++){
        var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/tendencia_count_year?VAR='+estadosList[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
        };
...
const getDataProgramasDIA = async () => {
  ...
  for (var opcion = 0;opcion< opcionesMultiSelectDIA.length;opcion++){
    var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/desercionDIA_count_year?ESTADO='+estadoDIASelected+'&NOMBRE='+ opcionesMultiSelectDIA[opcion],
        headers: { 
            'Content-Type': 'application/json'
        },
    };
...
const getDataProgramasDIS = async () => {
  ...
  for (var opcion = 0;opcion< opcionesMultiSelectDIS.length;opcion++){
    var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/desercionDIS_count_year?ESTADO='+estadoDISSelected+'&NOMBRE='+ opcionesMultiSelectDIS[opcion],
        headers: { 
            'Content-Type': 'application/json'
        },
    };
                      ...
                      <CChartLine
                        datasets={[
                          ...
                          },
                          {
                            ...
                            data: dataYearsGeneral['Cancelado'],
                          },
                          {
                            label: "Primer Curso",
                            fill: false,
