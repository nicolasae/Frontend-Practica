...
import {
 ...
 const DesercionIntersemestral = () =>{
    ...
    const [dataTablaDIS, setDataTablaDIS] = useState([])
    const fieldsTablaDIS = ['COD_PERIODO','NOMBRE','DURACION_SEMESTRES','ESTADO','CANTIDAD']
    ...
    const [collapseDISAnual,setCollapseDISAnual] = useState(false);
    ...
    const [loadingGraficoHistorico, setLoadingGraficoHistorico] = React.useState(true)
    ...
    const getYears = async() => { 
        ...
        console.log(yearsDataSemestre)
    }
    // Funciones Información Histórica
    const getDataTablaDIS = async () => {
        var axios = require('axios');
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/desercionDIS',
        headers: { 
        ...
        await setDataTablaDIS(dataQuery)
    }
    const getDataYearsGeneral = async() =>{ 
        ...
        for (var estado = 0;estado<estados.length;estado++){
            var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/desercionDIS_count_year?ESTADO='+estados[estado],
                headers: { 
                    'Content-Type': 'application/json'
                },
            };
        ...
        await setLoadingGraficoHistorico(false)
    }
    // Funciones Información Semestral
    const getDataYearWidgetPregrado = async () => {
        ...
        for (var estado=0; estado < estados.length; estado++) {
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIS_count?NIVEL=Pregrado&COD_PERIODO='+yearSelected+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const getDataYearWidgetPosgrado = async () => {
        ...
        for (var estado=0; estado < estados.length; estado++) {
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIS_count?NIVEL=Posgrado&COD_PERIODO='+yearSelected+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const widgetPosgrado= async () => {
        ...
        let permanece = ((dataYearsWidgetPosgrado['Permanece programa'])/total).toFixed(4);
        let cambio = ((dataYearsWidgetPosgrado['Cambio de programa'])/total).toFixed(4);
        let graduado = ((dataYearsWidgetPosgrado['Graduado'])/total).toFixed(4);
        let no_matriculado = ((dataYearsWidgetPosgrado['No matriculado'])/total).toFixed(4);
        let porcentajes_list = {}
        porcentajes_list = {
            permanece_porcentaje:(permanece*100).toFixed(1),
            cambio_porcentaje:(cambio*100).toFixed(1),
    ...
    const getListProgramas = async () => {
        ...
        var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIS_estados?NIVEL=Pregrado',
            headers: { 
                'Content-Type': 'application/json'
            },
        };
        var config1 = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIS_estados?NIVEL=Posgrado',
            headers: { 
                'Content-Type': 'application/json'
            },
        };
    ...
    const getDataPorProgramaPregrado = async() =>{
        ...
        for (var estado in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIS_count_year?NIVEL=Pregrado&NOMBRE='+programaSelectedPregrado+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const getDataPorProgramaPosgrado = async() =>{
        ...
        for (var estado = 0;estado<estados.length;estado++){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIS_count_year?NIVEL=Posgrado&NOMBRE='+programaSelectedPosgrado+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const toggleAnual = (e)=>{
        setCollapseDISAnual(!collapseDISAnual);
        setCollapseGeneral(false);
        setCollapseProgramas(false);
        e.preventDefault();
    }
    ...
    <>
        ...
        <CCard>
            ...
            <CCollapse show={collapseDISAnual}>               
                <CCardBody>                       
                        <div className="container">
