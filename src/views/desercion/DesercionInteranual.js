...
import {
 ...
 const DesercionInteranual = () =>{
    ...
    const getDataTablaDIA = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/desercionDIA',
        headers: { 
    ...
    const getDataYearsGeneral = async() =>{ 
        ...
        for (var estado = 0;estado<estados.length;estado++){
            for (var year = 2010;year <= actualYear-1;year++){
                var config = {
                method: 'get',
                url: 'https://backend-practica.herokuapp.com/api/desercionDIA_count?&COD_PERIODO='+year+'&ESTADO='+estados[estado],
                headers: { 
                    'Content-Type': 'application/json'
                },
                };
    ...
    const getDataYearWidgetPregrado = async () => {
        ...
        for (var estado=0; estado < estados.length; estado++) {
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIA_count?NIVEL=Pregrado&COD_PERIODO='+yearSelected+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const getDataYearWidgetPosgrado = async () => {
        ...
        for (var estado=0; estado < estados.length; estado++) {
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIA_count?NIVEL=Posgrado&COD_PERIODO='+yearSelected+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const getDataTablaProgramasPregrado = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/desercionDIA_estados?NIVEL=Pregrado',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataTablaProgramasPosgrado = async () => {
        ...
        var config = {
        method: 'get',
        url: 'https://backend-practica.herokuapp.com/api/desercionDIA_estados?NIVEL=Posgrado',
        headers: { 
            'Content-Type': 'application/json'
        },
        };
    ...
    const getDataPorProgramaPregrado = async() =>{
        ...
        for (var estado in estados){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIA_count_year?NIVEL=Pregrado&NOMBRE='+programaSelectedPregrado+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
    ...
    const getDataPorProgramaPosgrado = async() =>{
        ...
        for (var estado = 0;estado<estados.length;estado++){
            var config = {
            method: 'get',
            url: 'https://backend-practica.herokuapp.com/api/desercionDIA_count_year?NIVEL=Posgrado&NOMBRE='+programaSelectedPosgrado+'&ESTADO='+estados[estado],
            headers: { 
                'Content-Type': 'application/json'
            },
            };
